...
- `audit_evidence/` contains subject-local `external_interface_flow_chart`, `command_flow_chart`, `query_flow_chart`, `workflow_flow_chart`, `state_machine_chart`, and `state_composition_chart` SVG artifacts, plus scoped inputs and rendered visual evidence.
