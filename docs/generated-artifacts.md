...
- `audit_evidence/` contains subject-local external-interface flows, command/query flows, workflow flows, state-machine diagrams, `state_machine_state` composition diagrams, scoped inputs, and rendered visual evidence.
