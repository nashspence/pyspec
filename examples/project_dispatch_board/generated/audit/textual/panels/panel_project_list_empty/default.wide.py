...
LINES = [('static', 'No dispatch projects yet'), ('static', 'Create the first project to start coordinating work for this workspace.'), ('static', 'Empty dispatch queue illustration'), ('button', 'Project Create')]
