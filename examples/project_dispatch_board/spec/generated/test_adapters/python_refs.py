...
class LocalSignalRaise:
    LOCAL_SIGNAL_RAISE_PROJECT_DETAIL_LOADING_QUERY_INVOCATION_READ_PROJECT_FORBIDDEN_DATA_SIGNAL_ERROR = 'local_signal_raise.project.detail.loading.query_invocation.read_project.forbidden.data_signal.error'
    LOCAL_SIGNAL_RAISE_PROJECT_DETAIL_LOADING_QUERY_INVOCATION_READ_PROJECT_FOUND_DATA_SIGNAL_READY = 'local_signal_raise.project.detail.loading.query_invocation.read_project.found.data_signal.ready'
    LOCAL_SIGNAL_RAISE_PROJECT_DETAIL_LOADING_QUERY_INVOCATION_READ_PROJECT_NOT_FOUND_DATA_SIGNAL_ERROR = 'local_signal_raise.project.detail.loading.query_invocation.read_project.not_found.data_signal.error'
    LOCAL_SIGNAL_RAISE_PROJECT_DETAIL_LOADING_QUERY_INVOCATION_READ_PROJECT_UNAUTHENTICATED_DATA_SIGNAL_ERROR = 'local_signal_raise.project.detail.loading.query_invocation.read_project.unauthenticated.data_signal.error'
    LOCAL_SIGNAL_RAISE_PROJECT_DETAIL_READY_OPERATION_INVOCATION_APPROVE_APPROVED_DATA_SIGNAL_READY = 'local_signal_raise.project.detail.ready.operation_invocation.approve.approved.data_signal.ready'
    ...
    LOCAL_SIGNAL_RAISE_PROJECT_DETAIL_READY_OPERATION_INVOCATION_ARCHIVE_ARCHIVED_DATA_SIGNAL_READY = 'local_signal_raise.project.detail.ready.operation_invocation.archive.archived.data_signal.ready'
    ...
    LOCAL_SIGNAL_RAISE_PROJECT_LIST_EMPTY_OPERATION_INVOCATION_CREATE_CREATED_DATA_SIGNAL_READY = 'local_signal_raise.project.list.empty.operation_invocation.create.created.data_signal.ready'
    ...
    LOCAL_SIGNAL_RAISE_PROJECT_LIST_QUERY_INVOCATION_LIST_PROJECTS_FORBIDDEN_DATA_SIGNAL_ERROR = 'local_signal_raise.project.list.query_invocation.list_projects.forbidden.data_signal.error'
    LOCAL_SIGNAL_RAISE_PROJECT_LIST_QUERY_INVOCATION_LIST_PROJECTS_LISTED_DATA_SIGNAL_READY = 'local_signal_raise.project.list.query_invocation.list_projects.listed.data_signal.ready'
    LOCAL_SIGNAL_RAISE_PROJECT_LIST_QUERY_INVOCATION_LIST_PROJECTS_UNAUTHENTICATED_DATA_SIGNAL_ERROR = 'local_signal_raise.project.list.query_invocation.list_projects.unauthenticated.data_signal.error'
    LOCAL_SIGNAL_RAISE_PROJECT_LIST_QUERY_INVOCATION_LIST_PROJECTS_UNAVAILABLE_DATA_SIGNAL_ERROR = 'local_signal_raise.project.list.query_invocation.list_projects.unavailable.data_signal.error'
    LOCAL_SIGNAL_RAISE_PROJECT_LIST_READY_OPERATION_INVOCATION_CREATE_CREATED_DATA_SIGNAL_READY = 'local_signal_raise.project.list.ready.operation_invocation.create.created.data_signal.ready'
    ...
    LOCAL_SIGNAL_RAISE_PROJECT_LIST_READY_OPERATION_INVOCATION_SUBMIT_SUBMITTED_DATA_SIGNAL_READY = 'local_signal_raise.project.list.ready.operation_invocation.submit.submitted.data_signal.ready'
