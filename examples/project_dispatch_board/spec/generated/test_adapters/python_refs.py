...
class LocalSignalRaise:
    ...
    LOCAL_SIGNAL_RAISE_PROJECT_DETAIL_READY_OPERATION_INVOCATION_APPROVE_APPROVED_DATA_SIGNAL_PROJECT_LOADED = 'local_signal_raise.project.detail.ready.operation_invocation.approve.approved.data_signal.project_loaded'
    ...
    LOCAL_SIGNAL_RAISE_PROJECT_DETAIL_READY_OPERATION_INVOCATION_ARCHIVE_ARCHIVED_DATA_SIGNAL_PROJECT_LOADED = 'local_signal_raise.project.detail.ready.operation_invocation.archive.archived.data_signal.project_loaded'
    ...
    LOCAL_SIGNAL_RAISE_PROJECT_LIST_EMPTY_OPERATION_INVOCATION_CREATE_CREATED_DATA_SIGNAL_PROJECTS_LOADED = 'local_signal_raise.project.list.empty.operation_invocation.create.created.data_signal.projects_loaded'
    ...
    LOCAL_SIGNAL_RAISE_PROJECT_LIST_READY_OPERATION_INVOCATION_CREATE_CREATED_DATA_SIGNAL_PROJECTS_LOADED = 'local_signal_raise.project.list.ready.operation_invocation.create.created.data_signal.projects_loaded'
    ...
    LOCAL_SIGNAL_RAISE_PROJECT_LIST_READY_OPERATION_INVOCATION_SUBMIT_SUBMITTED_DATA_SIGNAL_PROJECTS_LOADED = 'local_signal_raise.project.list.ready.operation_invocation.submit.submitted.data_signal.projects_loaded'
