...
class LocalSignalRaise:
    ...
    LOCAL_SIGNAL_RAISE_PROJECT_LIST_QUERY_INVOCATION_LIST_PROJECTS_LISTED_DATA_SIGNAL_PROJECT_COLLECTION_EMPTY = 'local_signal_raise.project.list.query_invocation.list_projects.listed.data_signal.project_collection_empty'
